  ...
  <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-3xl text-gray-700 mb-16 leading-relaxed">
            Value-based access tailored to owners and contractors
          </p>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-10 mb-12 text-left max-w-2xl mx-auto shadow-sm">
            ...
            <ul className="text-xl text-gray-700 space-y-3">
              <li className="flex items-start gap-3"><Check className="h-6 w-6 text-green-600 mt-0.5" /> Value scales with your mobilization needs</li>
              <li className="flex items-start gap-3"><Check className="h-6 w-6 text-green-600 mt-0.5" /> Owner and contractor access differ by role</li>
            </ul>
          </div>
          ...
          >
            <Button className="bg-blue-600 hover:bg-blue-700 text-white px-10 py-5 rounded-xl text-xl font-semibold transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl">
              <span className="flex items-center">
                Request Access & Value Overview
